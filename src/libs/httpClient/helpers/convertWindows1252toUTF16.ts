...
export function convertWindows1252toUTF16(s: string) {
  return win1252toUTF16table.reduce(
    (convertedString, conversionRule) =>
      convertedString.replaceAll(conversionRule.win1252, conversionRule.utf16),
    s,
  );
}
